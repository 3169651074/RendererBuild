#ifndef RENDERERBUILD_TRIANGLE_HPP
#define RENDERERBUILD_TRIANGLE_HPP
...
namespace renderer {
    ...
    public:
        ...
        Triangle(size_t objectID, MaterialType materialType, size_t materialIndex,
                 const Point3 & p1, const Point3 & p2, const Point3 & p3) :
                 objectID(objectID), materialType(materialType), materialIndex(materialIndex), direction(Vec3())
        {
        ...
        Triangle(size_t objectID, MaterialType materialType, size_t materialIndex,
                 const Point3 & p1, const Point3 & p2, const Point3 & p3,
                 const Vec3 & normal1, const Vec3 & normal2, const Vec3 & normal3, const Vec3 & direction) :
                objectID(objectID), materialType(materialType), materialIndex(materialIndex), direction(direction)
        {
            points[0] = p1; points[1] = p2; points[2] = p3;
...
#endif //RENDERERBUILD_TRIANGLE_HPP
