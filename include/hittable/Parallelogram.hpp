#ifndef RENDERERBUILD_PARALLELOGRAM_HPP
#define RENDERERBUILD_PARALLELOGRAM_HPP
...
namespace renderer {
    ...
    public:
        Parallelogram(size_t objectID, MaterialType materialType, size_t materialIndex,
                const Point3 & q, const Vec3 & u, const Vec3 & v) :
                objectID(objectID), materialType(materialType), materialIndex(materialIndex), q(q), u(u), v(v)
        {
...
#endif //RENDERERBUILD_PARALLELOGRAM_HPP
