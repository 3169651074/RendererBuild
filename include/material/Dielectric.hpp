#ifndef RENDERERBUILD_DIELECTRIC_HPP
#define RENDERERBUILD_DIELECTRIC_HPP
...
namespace renderer {
    ...
    public:
        explicit Dielectric(double refractiveIndex = 1.0) ://材质不吸收光
...
#endif //RENDERERBUILD_DIELECTRIC_HPP
